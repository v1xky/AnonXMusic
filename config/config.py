...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "ANGEL ダ ᴍᴜsɪᴄ")
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/angel_updates")
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/angelsupports")
